...
pub const AERON_COUNTER_PUBLISHER_POSITION_NAME: &[u8; 18] = b"pub-pos (sampled)\0";
...
pub const AERON_COUNTER_CLUSTER_TRANSITION_MODULE_CONTROL_TOGGLE_TYPE_ID: u32 = 225;
