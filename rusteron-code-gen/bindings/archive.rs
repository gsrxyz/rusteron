...
pub type aeron_archive_credentials_encoded_credentials_supplier_func_t = ::std::option::Option<
    unsafe extern "C" fn(clientd: *mut ::std::os::raw::c_void) -> *mut aeron_archive_encoded_credentials_t,
>;
...
pub type aeron_archive_credentials_free_func_t = ::std::option::Option<
    unsafe extern "C" fn(credentials: *mut aeron_archive_encoded_credentials_t, clientd: *mut ::std::os::raw::c_void),
>;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of aeron_archive_replay_params_stct"][::std::mem::size_of::<aeron_archive_replay_params_stct>() - 40usize];
    ["Alignment of aeron_archive_replay_params_stct"]
        [::std::mem::align_of::<aeron_archive_replay_params_stct>() - 8usize];
    ["Offset of field: aeron_archive_replay_params_stct::bounding_limit_counter_id"]
        [::std::mem::offset_of!(aeron_archive_replay_params_stct, bounding_limit_counter_id) - 0usize];
    ...
    ["Offset of field: aeron_archive_replay_params_stct::subscription_registration_id"]
        [::std::mem::offset_of!(aeron_archive_replay_params_stct, subscription_registration_id) - 32usize];
};
#[doc = " Struct containing the available replay parameters."]
...
unsafe extern "C" {
    ...
    pub fn aeron_archive_replay_params_init(params: *mut aeron_archive_replay_params_t) -> ::std::os::raw::c_int;
}
...
const _: () = {
    ...
    ["Offset of field: aeron_archive_replication_params_stct::replication_channel"]
        [::std::mem::offset_of!(aeron_archive_replication_params_stct, replication_channel) - 24usize];
    ["Offset of field: aeron_archive_replication_params_stct::src_response_channel"]
        [::std::mem::offset_of!(aeron_archive_replication_params_stct, src_response_channel) - 32usize];
    ...
    ["Offset of field: aeron_archive_replication_params_stct::subscription_tag_id"]
        [::std::mem::offset_of!(aeron_archive_replication_params_stct, subscription_tag_id) - 48usize];
    ["Offset of field: aeron_archive_replication_params_stct::file_io_max_length"]
        [::std::mem::offset_of!(aeron_archive_replication_params_stct, file_io_max_length) - 56usize];
    ["Offset of field: aeron_archive_replication_params_stct::replication_session_id"]
        [::std::mem::offset_of!(aeron_archive_replication_params_stct, replication_session_id) - 60usize];
    ["Offset of field: aeron_archive_replication_params_stct::encoded_credentials"]
        [::std::mem::offset_of!(aeron_archive_replication_params_stct, encoded_credentials) - 64usize];
};
...
const _: () = {
    ...
    ["Offset of field: aeron_archive_recording_descriptor_stct::control_session_id"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_stct, control_session_id) - 0usize];
    ...
    ["Offset of field: aeron_archive_recording_descriptor_stct::start_timestamp"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_stct, start_timestamp) - 24usize];
    ...
    ["Offset of field: aeron_archive_recording_descriptor_stct::initial_term_id"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_stct, initial_term_id) - 56usize];
    ["Offset of field: aeron_archive_recording_descriptor_stct::segment_file_length"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_stct, segment_file_length) - 60usize];
    ["Offset of field: aeron_archive_recording_descriptor_stct::term_buffer_length"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_stct, term_buffer_length) - 64usize];
    ...
    ["Offset of field: aeron_archive_recording_descriptor_stct::stripped_channel"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_stct, stripped_channel) - 80usize];
    ["Offset of field: aeron_archive_recording_descriptor_stct::stripped_channel_length"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_stct, stripped_channel_length) - 88usize];
    ["Offset of field: aeron_archive_recording_descriptor_stct::original_channel"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_stct, original_channel) - 96usize];
    ["Offset of field: aeron_archive_recording_descriptor_stct::original_channel_length"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_stct, original_channel_length) - 104usize];
    ["Offset of field: aeron_archive_recording_descriptor_stct::source_identity"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_stct, source_identity) - 112usize];
    ["Offset of field: aeron_archive_recording_descriptor_stct::source_identity_length"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_stct, source_identity_length) - 120usize];
};
...
const _: () = {
    ...
    ["Offset of field: aeron_archive_recording_subscription_descriptor_stct::control_session_id"]
        [::std::mem::offset_of!(aeron_archive_recording_subscription_descriptor_stct, control_session_id) - 0usize];
    ["Offset of field: aeron_archive_recording_subscription_descriptor_stct::correlation_id"]
        [::std::mem::offset_of!(aeron_archive_recording_subscription_descriptor_stct, correlation_id) - 8usize];
    ["Offset of field: aeron_archive_recording_subscription_descriptor_stct::subscription_id"]
        [::std::mem::offset_of!(aeron_archive_recording_subscription_descriptor_stct, subscription_id) - 16usize];
    ["Offset of field: aeron_archive_recording_subscription_descriptor_stct::stream_id"]
        [::std::mem::offset_of!(aeron_archive_recording_subscription_descriptor_stct, stream_id) - 24usize];
    ["Offset of field: aeron_archive_recording_subscription_descriptor_stct::stripped_channel"]
        [::std::mem::offset_of!(aeron_archive_recording_subscription_descriptor_stct, stripped_channel) - 32usize];
    ["Offset of field: aeron_archive_recording_subscription_descriptor_stct::stripped_channel_length"][::std::mem::offset_of!(
...
#[doc = " Struct containing the details of a recording subscription"]
pub type aeron_archive_recording_subscription_descriptor_t = aeron_archive_recording_subscription_descriptor_stct;
...
const _: () = {
    ...
    ["Offset of field: aeron_archive_recording_signal_stct::recording_signal_code"]
        [::std::mem::offset_of!(aeron_archive_recording_signal_stct, recording_signal_code) - 32usize];
};
#[doc = " Struct containing the details of a recording signal."]
...
pub type aeron_archive_recording_signal_consumer_func_t = ::std::option::Option<
    unsafe extern "C" fn(recording_signal: *mut aeron_archive_recording_signal_t, clientd: *mut ::std::os::raw::c_void),
>;
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
unsafe extern "C" {
    ...
    pub fn aeron_archive_context_init(ctx: *mut *mut aeron_archive_context_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn aeron_archive_context_get_control_request_stream_id(ctx: *mut aeron_archive_context_t) -> i32;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn aeron_archive_context_get_control_response_stream_id(ctx: *mut aeron_archive_context_t) -> i32;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn aeron_archive_context_get_recording_events_stream_id(ctx: *mut aeron_archive_context_t) -> i32;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn aeron_archive_context_get_message_retry_attempts(ctx: *mut aeron_archive_context_t) -> u32;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn aeron_archive_context_get_control_term_buffer_length(ctx: *mut aeron_archive_context_t) -> usize;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn aeron_archive_context_get_control_mtu_length(ctx: *mut aeron_archive_context_t) -> usize;
}
unsafe extern "C" {
    #[doc = " Specify the default MTU length for the control request/response channels."]
...
unsafe extern "C" {
    pub fn aeron_archive_context_get_control_term_buffer_sparse(ctx: *mut aeron_archive_context_t) -> bool;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn aeron_archive_get_archive_context(aeron_archive: *mut aeron_archive_t) -> *mut aeron_archive_context_t;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn aeron_archive_check_for_error_response(aeron_archive: *mut aeron_archive_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn aeron_archive_replay_merge_close(replay_merge: *mut aeron_archive_replay_merge_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn aeron_archive_replay_merge_image(replay_merge: *mut aeron_archive_replay_merge_t) -> *mut aeron_image_t;
}
unsafe extern "C" {
    ...
    pub fn aeron_archive_replay_merge_is_merged(replay_merge: *mut aeron_archive_replay_merge_t) -> bool;
}
unsafe extern "C" {
    #[doc = " Has the replay_merge failed due to an error?\n\n @param replay_merge the replay_merge to check\n @return true if an error occurred"]
    pub fn aeron_archive_replay_merge_has_failed(replay_merge: *mut aeron_archive_replay_merge_t) -> bool;
}
unsafe extern "C" {
    #[doc = " Is the live destination added to the subscription?\n\n @param replay_merge the replay_merge to check\n @return true if the live destination is added to the subscription"]
    pub fn aeron_archive_replay_merge_is_live_added(replay_merge: *mut aeron_archive_replay_merge_t) -> bool;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type aeron_archive_persistent_subscription_context_t = aeron_archive_persistent_subscription_context_stct;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub struct aeron_archive_persistent_subscription_listener_stct {
    ...
    pub on_live_joined: ::std::option::Option<unsafe extern "C" fn(clientd: *mut ::std::os::raw::c_void)>,
    #[doc = " Invoked when the persistent subscription transitions from the live state.\n\n @param clientd the clientd set on this listener."]
    pub on_live_left: ::std::option::Option<unsafe extern "C" fn(clientd: *mut ::std::os::raw::c_void)>,
...
const _: () = {
    ...
    ["Offset of field: aeron_archive_persistent_subscription_listener_stct::on_live_joined"]
        [::std::mem::offset_of!(aeron_archive_persistent_subscription_listener_stct, on_live_joined) - 0usize];
    ["Offset of field: aeron_archive_persistent_subscription_listener_stct::on_live_left"]
        [::std::mem::offset_of!(aeron_archive_persistent_subscription_listener_stct, on_live_left) - 8usize];
    ["Offset of field: aeron_archive_persistent_subscription_listener_stct::on_error"]
        [::std::mem::offset_of!(aeron_archive_persistent_subscription_listener_stct, on_error) - 16usize];
    ["Offset of field: aeron_archive_persistent_subscription_listener_stct::clientd"]
        [::std::mem::offset_of!(aeron_archive_persistent_subscription_listener_stct, clientd) - 24usize];
};
...
#[doc = " Listener for events from a persistent subscription.\n <p>\n All callbacks are invoked from the thread that calls aeron_archive_persistent_subscription_poll\n or aeron_archive_persistent_subscription_controlled_poll."]
pub type aeron_archive_persistent_subscription_listener_t = aeron_archive_persistent_subscription_listener_stct;
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of aeron_archive_proxy_stct"][::std::mem::size_of::<aeron_archive_proxy_stct>() - 8424usize];
    ["Alignment of aeron_archive_proxy_stct"][::std::mem::align_of::<aeron_archive_proxy_stct>() - 8usize];
    ["Offset of field: aeron_archive_proxy_stct::ctx"][::std::mem::offset_of!(aeron_archive_proxy_stct, ctx) - 0usize];
...
unsafe extern "C" {
    pub fn aeron_archive_proxy_close(archive_proxy: *mut aeron_archive_proxy_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn aeron_archive_proxy_delete(archive_proxy: *mut aeron_archive_proxy_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn aeron_archive_proxy_archive_id(archive_proxy: *mut aeron_archive_proxy_t, correlation_id: i64) -> bool;
}
unsafe extern "C" {
...
const _: () = {
    ...
    ["Offset of field: aeron_archive_control_response_poller_stct::fragment_limit"]
        [::std::mem::offset_of!(aeron_archive_control_response_poller_stct, fragment_limit) - 8usize];
    ["Offset of field: aeron_archive_control_response_poller_stct::fragment_assembler"]
        [::std::mem::offset_of!(aeron_archive_control_response_poller_stct, fragment_assembler) - 16usize];
    ["Offset of field: aeron_archive_control_response_poller_stct::error_on_fragment"]
        [::std::mem::offset_of!(aeron_archive_control_response_poller_stct, error_on_fragment) - 24usize];
    ["Offset of field: aeron_archive_control_response_poller_stct::control_session_id"]
        [::std::mem::offset_of!(aeron_archive_control_response_poller_stct, control_session_id) - 32usize];
    ["Offset of field: aeron_archive_control_response_poller_stct::correlation_id"]
        [::std::mem::offset_of!(aeron_archive_control_response_poller_stct, correlation_id) - 40usize];
    ...
    ["Offset of field: aeron_archive_control_response_poller_stct::recording_id"]
        [::std::mem::offset_of!(aeron_archive_control_response_poller_stct, recording_id) - 56usize];
    ["Offset of field: aeron_archive_control_response_poller_stct::subscription_id"]
        [::std::mem::offset_of!(aeron_archive_control_response_poller_stct, subscription_id) - 64usize];
    ...
    ["Offset of field: aeron_archive_control_response_poller_stct::recording_signal_code"]
        [::std::mem::offset_of!(aeron_archive_control_response_poller_stct, recording_signal_code) - 80usize];
    ...
    ["Offset of field: aeron_archive_control_response_poller_stct::error_message"]
        [::std::mem::offset_of!(aeron_archive_control_response_poller_stct, error_message) - 88usize];
    ["Offset of field: aeron_archive_control_response_poller_stct::error_message_malloced_len"]
        [::std::mem::offset_of!(aeron_archive_control_response_poller_stct, error_message_malloced_len) - 96usize];
    ["Offset of field: aeron_archive_control_response_poller_stct::encoded_challenge_buffer"]
        [::std::mem::offset_of!(aeron_archive_control_response_poller_stct, encoded_challenge_buffer) - 104usize];
    ["Offset of field: aeron_archive_control_response_poller_stct::encoded_challenge_buffer_malloced_len"][::std::mem::offset_of!(
        aeron_archive_control_response_poller_stct,
        encoded_challenge_buffer_malloced_len
    )
        - 112usize];
    ["Offset of field: aeron_archive_control_response_poller_stct::encoded_challenge"]
        [::std::mem::offset_of!(aeron_archive_control_response_poller_stct, encoded_challenge) - 120usize];
    ...
    ["Offset of field: aeron_archive_control_response_poller_stct::is_poll_complete"]
        [::std::mem::offset_of!(aeron_archive_control_response_poller_stct, is_poll_complete) - 140usize];
    ...
    ["Offset of field: aeron_archive_control_response_poller_stct::is_code_error"]
        [::std::mem::offset_of!(aeron_archive_control_response_poller_stct, is_code_error) - 142usize];
    ["Offset of field: aeron_archive_control_response_poller_stct::is_control_response"]
        [::std::mem::offset_of!(aeron_archive_control_response_poller_stct, is_control_response) - 143usize];
    ["Offset of field: aeron_archive_control_response_poller_stct::was_challenged"]
        [::std::mem::offset_of!(aeron_archive_control_response_poller_stct, was_challenged) - 144usize];
    ["Offset of field: aeron_archive_control_response_poller_stct::is_recording_signal"]
        [::std::mem::offset_of!(aeron_archive_control_response_poller_stct, is_recording_signal) - 145usize];
};
...
const _: () = {
    ...
    ["Offset of field: aeron_archive_recording_descriptor_poller_stct::subscription"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_poller_stct, subscription) - 8usize];
    ["Offset of field: aeron_archive_recording_descriptor_poller_stct::control_session_id"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_poller_stct, control_session_id) - 16usize];
    ["Offset of field: aeron_archive_recording_descriptor_poller_stct::fragment_limit"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_poller_stct, fragment_limit) - 24usize];
    ["Offset of field: aeron_archive_recording_descriptor_poller_stct::fragment_assembler"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_poller_stct, fragment_assembler) - 32usize];
    ["Offset of field: aeron_archive_recording_descriptor_poller_stct::error_on_fragment"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_poller_stct, error_on_fragment) - 40usize];
    ["Offset of field: aeron_archive_recording_descriptor_poller_stct::correlation_id"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_poller_stct, correlation_id) - 48usize];
    ["Offset of field: aeron_archive_recording_descriptor_poller_stct::remaining_record_count"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_poller_stct, remaining_record_count) - 56usize];
    ["Offset of field: aeron_archive_recording_descriptor_poller_stct::recording_descriptor_consumer"][::std::mem::offset_of!(
        aeron_archive_recording_descriptor_poller_stct,
        recording_descriptor_consumer
    ) - 64usize];
    ["Offset of field: aeron_archive_recording_descriptor_poller_stct::recording_descriptor_consumer_clientd"][::std::mem::offset_of!(
        aeron_archive_recording_descriptor_poller_stct,
        recording_descriptor_consumer_clientd
    )
        - 72usize];
    ["Offset of field: aeron_archive_recording_descriptor_poller_stct::is_dispatch_complete"]
        [::std::mem::offset_of!(aeron_archive_recording_descriptor_poller_stct, is_dispatch_complete) - 80usize];
};
...
pub type aeron_archive_recording_descriptor_poller_t = aeron_archive_recording_descriptor_poller_stct;
unsafe extern "C" {
...
pub struct aeron_archive_recording_subscription_descriptor_poller_stct {
    ...
    pub recording_subscription_descriptor_consumer: aeron_archive_recording_subscription_descriptor_consumer_func_t,
    pub recording_subscription_descriptor_consumer_clientd: *mut ::std::os::raw::c_void,
    pub is_dispatch_complete: bool,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of aeron_archive_recording_subscription_descriptor_poller_stct"]
        [::std::mem::size_of::<aeron_archive_recording_subscription_descriptor_poller_stct>() - 88usize];
    ["Alignment of aeron_archive_recording_subscription_descriptor_poller_stct"]
        [::std::mem::align_of::<aeron_archive_recording_subscription_descriptor_poller_stct>() - 8usize];
    ["Offset of field: aeron_archive_recording_subscription_descriptor_poller_stct::ctx"]
        [::std::mem::offset_of!(aeron_archive_recording_subscription_descriptor_poller_stct, ctx) - 0usize];
    ["Offset of field: aeron_archive_recording_subscription_descriptor_poller_stct::subscription"][::std::mem::offset_of!(
        aeron_archive_recording_subscription_descriptor_poller_stct,
        subscription
    ) - 8usize];
    ["Offset of field: aeron_archive_recording_subscription_descriptor_poller_stct::control_session_id"][::std::mem::offset_of!(
        aeron_archive_recording_subscription_descriptor_poller_stct,
        control_session_id
    ) - 16usize];
    ["Offset of field: aeron_archive_recording_subscription_descriptor_poller_stct::fragment_limit"][::std::mem::offset_of!(
        aeron_archive_recording_subscription_descriptor_poller_stct,
        fragment_limit
    ) - 24usize];
    ["Offset of field: aeron_archive_recording_subscription_descriptor_poller_stct::fragment_assembler"][::std::mem::offset_of!(
        aeron_archive_recording_subscription_descriptor_poller_stct,
        fragment_assembler
    ) - 32usize];
    ["Offset of field: aeron_archive_recording_subscription_descriptor_poller_stct::error_on_fragment"][::std::mem::offset_of!(
        aeron_archive_recording_subscription_descriptor_poller_stct,
        error_on_fragment
    ) - 40usize];
    ["Offset of field: aeron_archive_recording_subscription_descriptor_poller_stct::correlation_id"][::std::mem::offset_of!(
        aeron_archive_recording_subscription_descriptor_poller_stct,
        correlation_id
    ) - 48usize];
    ["Offset of field: aeron_archive_recording_subscription_descriptor_poller_stct::remaining_subscription_count"][::std::mem::offset_of!(
        aeron_archive_recording_subscription_descriptor_poller_stct,
    ...
    ["Offset of field: aeron_archive_recording_subscription_descriptor_poller_stct::is_dispatch_complete"][::std::mem::offset_of!(
        aeron_archive_recording_subscription_descriptor_poller_stct,
...
pub struct aeron_archive_stct {
    ...
    pub recording_subscription_descriptor_poller: *mut aeron_archive_recording_subscription_descriptor_poller_t,
    pub control_session_id: i64,
    pub archive_id: i64,
...
const _: () = {
    ...
    ["Offset of field: aeron_archive_stct::owns_ctx"][::std::mem::offset_of!(aeron_archive_stct, owns_ctx) - 0usize];
    ["Offset of field: aeron_archive_stct::ctx"][::std::mem::offset_of!(aeron_archive_stct, ctx) - 8usize];
    ["Offset of field: aeron_archive_stct::lock"][::std::mem::offset_of!(aeron_archive_stct, lock) - 16usize];
    ...
    ["Offset of field: aeron_archive_stct::recording_subscription_descriptor_poller"]
        [::std::mem::offset_of!(aeron_archive_stct, recording_subscription_descriptor_poller) - 120usize];
